...
# -*- coding: utf-8 -*-
#
# iottly-sdk documentation build configuration file, created by
...
project = 'iottly-sdk'
copyright = '2020, TomorrowData Srl'
author = 'TomorrowData Srl'
...
htmlhelp_basename = 'iottly-sdkdoc'
...
latex_documents = [
    (master_doc, 'iottly-sdk.tex', 'iottly-sdk Documentation',
     'TomorrowData Srl', 'manual'),
]
